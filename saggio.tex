...
\begin{multicols}{2}
	...
	We will talk about each extension related works separately.
...
A motivation of the absence of similar works can possibly found in the Chrome API that is really poor in terms of functionality and can result in lack of interest to patch security issues coming from the use of extensions. If in near future, Google decides to increase the functionality of his API in the extensions management maybe some interesting solution in this field could appear.
...
The extension occupy less of 50MB of RAM for an hour of screenshots taken every minute. The impact on the CPU is negligible.
