...
\begin{figure}[H]
	...
	\end{center}
\end{figure}
Chrome should improve their task manager, to give the usesr more knowledge about what is happening in their pc, because is possible to create a timed or a smart bomb with a simple \textsc{while(true)} cycle, and it can crash chrome, because the sandbox sometimes can't handle it.
